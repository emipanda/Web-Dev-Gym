...
namespace Web_Dev_Proj_Gym.Migrations
{
    ...
    [Migration("20210918070951_18.9morning")]
    partial class _189morning
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web_Dev_Proj_Gym.Models.Admin", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("ManagersBranchID")
                        .HasColumnType("int");

                    b.HasKey("ID");

                    b.HasIndex("ManagersBranchID");
            ...
            modelBuilder.Entity("Web_Dev_Proj_Gym.Models.Admin", b =>
                {
                    b.HasOne("Web_Dev_Proj_Gym.Models.Branch", "ManagersBranch")
                        .WithMany()
                        .HasForeignKey("ManagersBranchID");

                    b.Navigation("ManagersBranch");
                });
